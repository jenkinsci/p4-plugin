...
import org.jenkinsci.plugins.p4_client.DummyServer;
import org.jenkinsci.plugins.p4_client.P4Server;
import org.jenkinsci.plugins.p4_client.PerforceScm;
import org.jenkinsci.plugins.p4_client.PerforceScm.DescriptorImpl;
import org.jenkinsci.plugins.p4_client.browsers.P4WebBrowser;
import org.jenkinsci.plugins.p4_client.browsers.SwarmBrowser;
...
import org.jenkinsci.plugins.p4_client.workspace.ManualWorkspaceImpl;
...
import org.jenkinsci.plugins.p4_client.workspace.WorkspaceDescriptor;
import org.jenkinsci.plugins.p4_client.workspace.WorkspaceSpec;
...
public class ConnectionTest {
	...
	public void testFreeStyleProject_buildLabel() throws Exception {
		...
		page = jenkins.createWebClient().getPage(build, "tagBuild");
		text = page.asText();
		assertTrue(text.contains("Build-1\tJenkinsBuild: #1\tjenkins\t@40"));
