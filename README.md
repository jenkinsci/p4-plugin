...
[![Jenkins Version](https://img.shields.io/badge/Jenkins-2.528.3%2B-green.svg)](https://jenkins.io/download/)
[![Helix Core](https://img.shields.io/badge/P4%20Server-2022.2%2B-green.svg)](https://www.perforce.com/products/helix-core)
[![Helix Swarm](https://img.shields.io/badge/P4%20Code%20Review-2024.4%2B-green.svg)](https://www.perforce.com/products/helix-swarm)

Jenkins plugin for a Perforce P4 Server (P4D).
...
- Jenkins 2.528.3 or greater.
- P4 Server 2022.2 or greater.
- Minimum P4 Protection of `open` for the Jenkins user.
- Review Build feature requires P4 Code Review 2024.4 or greater.

## Known Limitations

- One Jenkins job per P4 Code Review branch.
- P4 'Build Farm' servers are not supported, they were superseded by P4 Commit-Edge servers back in 2013.2
